       ...
       /* TrajectoryActionBuilder move1 = drive.actionBuilder(startPose)
        ...
        Actions.runBlocking(
                ...
                drive.actionBuilder(startPose)
                        ...
                        .stopAndAdd(new ParallelAction(setTurret(TURRET_MAX), new SleepAction(0.1), launchRoutine()))

                        // --- CYCLE 2: PICKUP 1 (With Stopper) ---
                        // 1. Move quickly to the "Stopper" (2 inches away from ball)
                        .strafeToLinearHeading(new Vector2d(34, 15), Math.toRadians(90))
                        ...
                        .strafeToLinearHeading(new Vector2d(58, 19), Math.toRadians(-20))
